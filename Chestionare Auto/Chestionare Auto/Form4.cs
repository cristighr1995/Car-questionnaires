...
namespace Chestionar_Auto_Bun
{
    public partial class Form4 : Form
    {
        ...
        StreamReader question = new StreamReader(Application.StartupPath + "\\intrebari3.txt"); 
        ...
        private void Form4_Load(object sender, EventArgs e)
        {
            ...
            this.Height = 700;
            this.Width = 1120;
            this.Text = "Chestionarul #3";
            this.BackgroundImage = Image.FromFile(Application.StartupPath + "\\imagini Form1\\3.jpg");
        ...
        { 
            ...
            if (answersNo < totalNo)
            {
                ...
                if (label1.Text == item[1, 0])
                {
                    ...
                    pictureBox4.BackgroundImage = Image.FromFile(Application.StartupPath + "\\imagini PictureBox 3\\2.jpg");
                ...
                {
                    pictureBox4.BringToFront();
                    pictureBox4.BackgroundImage = Image.FromFile(Application.StartupPath + "\\imagini PictureBox 3\\3.jpg");
                    pictureBox4.BackgroundImageLayout = ImageLayout.Stretch;
                    label1.Width = 632;
                }
                ...
                {
                    pictureBox4.BringToFront();
                    pictureBox4.BackgroundImage = Image.FromFile(Application.StartupPath + "\\imagini PictureBox 3\\4.jpg");
                    pictureBox4.BackgroundImageLayout = ImageLayout.Stretch;
                    label1.Width = 632;
                }
                if (label1.Text == item[15, 0])
                {
                    pictureBox4.BringToFront();
                    pictureBox4.BackgroundImage = Image.FromFile(Application.StartupPath + "\\imagini PictureBox 3\\16.jpg");
                    pictureBox4.BackgroundImageLayout = ImageLayout.Stretch;
                    label1.Width = 632;
                }
                if (label1.Text == item[16, 0])
                {
                    pictureBox4.BringToFront();
                    pictureBox4.BackgroundImage = Image.FromFile(Application.StartupPath + "\\imagini PictureBox 3\\17.jpg");
                    pictureBox4.BackgroundImageLayout = ImageLayout.Stretch;
                    label1.Width = 632;
                }
                ...
                {
                    pictureBox4.BringToFront();
                    pictureBox4.BackgroundImage = Image.FromFile(Application.StartupPath + "\\imagini PictureBox 3\\26.jpg");
                    pictureBox4.BackgroundImageLayout = ImageLayout.Stretch;
                    label1.Width = 632;
                }
            }
