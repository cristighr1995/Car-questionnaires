...
namespace Chestionar_Auto_Bun
{
    public partial class Form7 : Form
    {
        ...
        StreamReader question = new StreamReader(Application.StartupPath + "\\intrebari6.txt"); 
        ...
        private void Form7_Load(object sender, EventArgs e)
        {
            ...
            this.Height = 700;
            this.Width = 1120;
            this.Text = "Chestionarul #6";
            this.BackgroundImage = Image.FromFile(Application.StartupPath + "\\imagini Form1\\back7.jpg");
        ...
        { 
            ...
            if (answersNo < totalNo)
            {
                ...
                if (label1.Text == item[1, 0])
                {
                    ...
                    pictureBox4.BackgroundImage = Image.FromFile(Application.StartupPath + "\\imagini PictureBox 6\\2.jpg");
                ...
                {
                    pictureBox4.BringToFront();
                    pictureBox4.BackgroundImage = Image.FromFile(Application.StartupPath + "\\imagini PictureBox 6\\3.jpg");
                    pictureBox4.BackgroundImageLayout = ImageLayout.Stretch;
                    label1.Width = 632;
                }
                if (label1.Text == item[4, 0])
                {
                    pictureBox4.BringToFront();
                    pictureBox4.BackgroundImage = Image.FromFile(Application.StartupPath + "\\imagini PictureBox 6\\5.jpg");
                    pictureBox4.BackgroundImageLayout = ImageLayout.Stretch;
                    label1.Width = 632;
                }
                ...
                {
                    pictureBox4.BringToFront();
                    pictureBox4.BackgroundImage = Image.FromFile(Application.StartupPath + "\\imagini PictureBox 6\\7.jpg");
                    pictureBox4.BackgroundImageLayout = ImageLayout.Stretch;
                    label1.Width = 632;
                }
                ...
                {
                    pictureBox4.BringToFront();
                    pictureBox4.BackgroundImage = Image.FromFile(Application.StartupPath + "\\imagini PictureBox 6\\10.jpg");
                    pictureBox4.BackgroundImageLayout = ImageLayout.Stretch;
                    label1.Width = 632;
                }
                ...
                {
                    pictureBox4.BringToFront();
                    pictureBox4.BackgroundImage = Image.FromFile(Application.StartupPath + "\\imagini PictureBox 6\\11.jpg");
                    pictureBox4.BackgroundImageLayout = ImageLayout.Stretch;
                    label1.Width = 632;
                }
                if (label1.Text == item[17, 0])
                {
                    pictureBox4.BringToFront();
                    pictureBox4.BackgroundImage = Image.FromFile(Application.StartupPath + "\\imagini PictureBox 6\\18.jpg");
                    pictureBox4.BackgroundImageLayout = ImageLayout.Stretch;
                    label1.Width = 632;
                }
                ...
                {
                    pictureBox4.BringToFront();
                    pictureBox4.BackgroundImage = Image.FromFile(Application.StartupPath + "\\imagini PictureBox 6\\25.jpg");
                    pictureBox4.BackgroundImageLayout = ImageLayout.Stretch;
                    label1.Width = 632;
                }
            }
