...
namespace Chestionar_Auto_Bun
{
    public partial class Form6 : Form
    {
        ...
        StreamReader question = new StreamReader(Application.StartupPath + "\\intrebari5.txt"); 
        ...
        private void Form6_Load(object sender, EventArgs e)
        {
            ...
            this.Height = 700;
            this.Width = 1120;
            this.Text = "Chestionarul #5";
            this.BackgroundImage = Image.FromFile(Application.StartupPath + "\\imagini Form1\\5.jpg");
        ...
        { 
            ...
            if (answersNo < totalNo)
            {
                ...
                if (label1.Text == item[1, 0])
                {
                    ...
                    pictureBox4.BackgroundImage = Image.FromFile(Application.StartupPath + "\\imagini PictureBox 5\\2.jpg");
                ...
                {
                    pictureBox4.BringToFront();
                    pictureBox4.BackgroundImage = Image.FromFile(Application.StartupPath + "\\imagini PictureBox 5\\3.jpg");
                    pictureBox4.BackgroundImageLayout = ImageLayout.Stretch;
                    label1.Width = 632;
                }
                ...
                {
                    pictureBox4.BringToFront();
                    pictureBox4.BackgroundImage = Image.FromFile(Application.StartupPath + "\\imagini PictureBox 5\\8.jpg");
                    pictureBox4.BackgroundImageLayout = ImageLayout.Stretch;
                    label1.Width = 632;
                }
                ...
                {
                    pictureBox4.BringToFront();
                    pictureBox4.BackgroundImage = Image.FromFile(Application.StartupPath + "\\imagini PictureBox 5\\10.jpg");
                    pictureBox4.BackgroundImageLayout = ImageLayout.Stretch;
                    label1.Width = 632;
                }
            }
