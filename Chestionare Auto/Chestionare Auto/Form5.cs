...
namespace Chestionar_Auto_Bun
{
    public partial class Form5 : Form
    {
        ...
        StreamReader question = new StreamReader(Application.StartupPath + "\\intrebari4.txt"); 
        ...
        private void Form5_Load(object sender, EventArgs e)
        {
            ...
            this.Height = 700;
            this.Width = 1120;
            this.Text = "Chestionarul #4";
            this.BackgroundImage = Image.FromFile(Application.StartupPath + "\\imagini Form1\\4.jpg");
            ...
            pictureBox4.BackgroundImage = Image.FromFile(Application.StartupPath + "\\imagini PictureBox 4\\1.jpg");
        ...
        { 
            ...
            if (answersNo < totalNo)
            {
                ...
                {
                    pictureBox4.BringToFront();
                    pictureBox4.BackgroundImage = Image.FromFile(Application.StartupPath + "\\imagini PictureBox 4\\2.jpg");
                    pictureBox4.BackgroundImageLayout = ImageLayout.Stretch;
                    label1.Width = 632;
                }
                ...
                {
                    pictureBox4.BringToFront();
                    pictureBox4.BackgroundImage = Image.FromFile(Application.StartupPath + "\\imagini PictureBox 4\\3.jpg");
                    pictureBox4.BackgroundImageLayout = ImageLayout.Stretch;
                    label1.Width = 632;
                }
                ...
                {
                    pictureBox4.BringToFront();
                    pictureBox4.BackgroundImage = Image.FromFile(Application.StartupPath + "\\imagini PictureBox 4\\4.jpg");
                    pictureBox4.BackgroundImageLayout = ImageLayout.Stretch;
                    label1.Width = 632;
                }
                ...
                {
                    pictureBox4.BringToFront();
                    pictureBox4.BackgroundImage = Image.FromFile(Application.StartupPath + "\\imagini PictureBox 4\\5.jpg");
                    pictureBox4.BackgroundImageLayout = ImageLayout.Stretch;
                    label1.Width = 632;
                }
                if (label1.Text == item[5, 0])
                {
                    pictureBox4.BringToFront();
                    pictureBox4.BackgroundImage = Image.FromFile(Application.StartupPath + "\\imagini PictureBox 4\\6.jpg");
                    pictureBox4.BackgroundImageLayout = ImageLayout.Stretch;
                    label1.Width = 632;
                }
                if (label1.Text == item[7, 0])
                {
                    pictureBox4.BringToFront();
                    pictureBox4.BackgroundImage = Image.FromFile(Application.StartupPath + "\\imagini PictureBox 4\\8.jpg");
                    pictureBox4.BackgroundImageLayout = ImageLayout.Stretch;
                    label1.Width = 632;
                }
                ...
                {
                    pictureBox4.BringToFront();
                    pictureBox4.BackgroundImage = Image.FromFile(Application.StartupPath + "\\imagini PictureBox 4\\9.jpg");
                    pictureBox4.BackgroundImageLayout = ImageLayout.Stretch;
                    label1.Width = 632;
                }
            }
