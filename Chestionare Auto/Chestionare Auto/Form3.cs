...
namespace Chestionar_Auto_Bun
{
    public partial class Form3 : Form
    {
        ...
        StreamReader question = new StreamReader(Application.StartupPath + "\\intrebari2.txt"); 
        ...
        private void Form3_Load(object sender, EventArgs e)
        {
            ...
            this.Height = 700;
            this.Width = 1120;
            this.Text = "Chestionarul #2";
            this.BackgroundImage = Image.FromFile(Application.StartupPath + "\\imagini Form1\\2.jpg");
            ...
            pictureBox4.BackgroundImage = Image.FromFile(Application.StartupPath + "\\imagini PictureBox 2\\1.jpg");
        ...
        { 
            ...
            if (answersNo < totalNo)
            {
                ...
                answerLabel[0, 0].Font = new Font("Calibri", 11);
                answerLabel[0, 1].Font = new Font("Calibri", 11);
                answerLabel[0, 2].Font = new Font("Calibri", 11);

                if (label1.Text == item[6, 0])
                {
                    answerLabel[0, 0].Font = new Font("Calibri", 10);
                    answerLabel[0, 1].Font = new Font("Calibri", 10);
                    answerLabel[0, 2].Font = new Font("Calibri", 10);
                }
                if (label1.Text == item[14, 0])
                {
                    answerLabel[0, 0].Font = new Font("Calibri", 10);
                    answerLabel[0, 1].Font = new Font("Calibri", 10);
                    answerLabel[0, 2].Font = new Font("Calibri", 10);
                }
                if (label1.Text == item[0, 0])
                {
                ...
                if (label1.Text == item[20, 0])
                {
                    pictureBox4.BringToFront();
                    pictureBox4.BackgroundImage = Image.FromFile(Application.StartupPath + "\\imagini PictureBox 2\\21.jpg");
                    pictureBox4.BackgroundImageLayout = ImageLayout.Stretch;
                    label1.Width = 632;
                }
                if (label1.Text == item[21, 0])
                {
                    pictureBox4.BringToFront();
                    pictureBox4.BackgroundImage = Image.FromFile(Application.StartupPath + "\\imagini PictureBox 2\\22.jpg");
                    pictureBox4.BackgroundImageLayout = ImageLayout.Stretch;
                    label1.Width = 632;
                }
                if (label1.Text == item[22, 0])
                {
                    pictureBox4.BringToFront();
                    pictureBox4.BackgroundImage = Image.FromFile(Application.StartupPath + "\\imagini PictureBox 2\\23.jpg");
                    pictureBox4.BackgroundImageLayout = ImageLayout.Stretch;
                    label1.Width = 632;
                }
                if (label1.Text == item[23, 0])
                {
                    pictureBox4.BringToFront();
                    pictureBox4.BackgroundImage = Image.FromFile(Application.StartupPath + "\\imagini PictureBox 2\\24.jpg");
                    pictureBox4.BackgroundImageLayout = ImageLayout.Stretch;
                    label1.Width = 632;
                }
                if (label1.Text == item[24, 0])
                {
                    pictureBox4.BringToFront();
                    pictureBox4.BackgroundImage = Image.FromFile(Application.StartupPath + "\\imagini PictureBox 2\\25.jpg");
                    pictureBox4.BackgroundImageLayout = ImageLayout.Stretch;
                    label1.Width = 632;
                }
                ...
                {
                    pictureBox4.BringToFront();
                    pictureBox4.BackgroundImage = Image.FromFile(Application.StartupPath + "\\imagini PictureBox 2\\26.jpg");
                    pictureBox4.BackgroundImageLayout = ImageLayout.Stretch;
                    label1.Width = 632;
                }
            }
